    ...
    builder: (context) {
      return MultiBlocProvider(
        providers: [
          ...
          BlocProvider(
            create: (_) => GetIt.I<AddToCartCubit>(),
          ),
        ],
...
class TextClickButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final borderColor =
        isSelected ? context.colors.easyColor : context.colors.dimGrey;
    return GestureDetector(
      ...
      child: Container(
        ...
        child: AppText(
          text ?? '',
          color: isDisabled ? context.colors.disableIcon : context.colors.black,
        ),
      ),
    );
  }
